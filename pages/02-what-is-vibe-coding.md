...
<div class="h-full flex flex-col pt-6">
  <Reveal :delay="100">
    <h1>What is <span class="relative inline-block">Vibe Coding<Rough class="!absolute -left-1 -bottom-4 pointer-events-none" shape="line" :width="295" :height="20" color="#c25c3b" :stroke-width="3.5" :delay="700" /></span>?</h1>
  </Reveal>
  ...
  <Reveal :delay="900" class="mt-4">
    <ul class="m-0 max-w-[40rem] list-none p-0 space-y-2">
      <li class="!ml-0 flex items-start gap-3 !text-2xl !leading-[1.45] !text-ink">
        ...
        <span>Building apps in everyday language using <b>AI agents</b>.</span>
      </li>
      <li class="!ml-0 flex items-start gap-3 !text-2xl !leading-[1.45] !text-ink">
        <span aria-hidden="true" class="mt-3 size-2 shrink-0 rounded-full bg-ink"></span>
        <span>Very new, fast-moving progress: it only started in 2025.</span>
      </li>
    </ul>
  </Reveal>
...
<!--
Beat for this slide: a simple definition first, then the origin of the term.

- Definition: build an app without needing to look at the code. Reinforce the cue card line: the code STILL EXISTS, AI writes it, we direct it (not magic, not "no code").
- Origin of the term: coined by Andrej Karpathy (OpenAI co-founder, former Tesla AI Director) in a post on X on February 2, 2025 (the exact date can still be mentioned out loud).
- The slide animates automatically: title → underline → definition → quote. Leave a ~3 second pause before you start talking.
-->

---
kicker: why learn vibe coding
---

<div class="h-full flex flex-col pt-6">
  <Reveal :delay="100">
    <h1>Why learn <span class="relative inline-block">vibe coding<Rough class="!absolute -left-1 -bottom-4 pointer-events-none" shape="line" :width="275" :height="20" color="#c25c3b" :stroke-width="3.5" :delay="700" /></span>?</h1>
  </Reveal>
  ...
  <div class="mt-6 max-w-[46rem] flex flex-col gap-4">
    <Reveal :delay="900">
      <div class="flex items-start gap-3 text-2xl leading-[1.45] text-ink">
        <span aria-hidden="true" class="mt-3 size-2 shrink-0 rounded-full bg-ink"></span>
        <span>AI is transforming how software gets built. Prototypes now take hours, not weeks.</span>
      </div>
    </Reveal>
        <Reveal :delay="2100">
      <div class="flex items-start gap-3 text-2xl leading-[1.45] text-ink">
        <span aria-hidden="true" class="mt-3 size-2 shrink-0 rounded-full bg-ink"></span>
        <span>AI agents are useful for far more than just coding.</span>
      </div>
    </Reveal>
  </div>
</div>
...
<!--
Beat for this slide: two reasons why vibe coding is worth learning now.

- AI is changing how software gets built: one person directing AI agents can build far more with far less effort. This is already happening, not a prediction.
- AI agents are useful beyond coding: the same work pattern (directing AI, checking its output, iterating) is starting to show up in design, research, marketing, and other fields. The same shift is coming to other industries too.
- The slide animates automatically: title, underline, then the points in sequence. A small agent parade keeps walking along the bottom of the slide.
-->
...
<div class="h-full flex flex-col pt-6">
  ...
  <div class="relative mx-auto mt-2 h-[360px] w-[860px]">
    ...
    <Reveal :delay="1050" class="!absolute inset-0 text-[0.75rem] text-ink-soft">
      <span class="absolute left-0 top-[232px] w-[50px] text-right">4 hrs</span>
      <span class="absolute left-0 top-[172px] w-[50px] text-right">8 hrs</span>
      <span class="absolute left-0 top-[112px] w-[50px] text-right">12 hrs</span>
      <span class="absolute left-0 top-[52px] w-[50px] text-right">16 hrs</span>
    </Reveal>
    <Reveal :delay="1000" class="!absolute left-[78px] top-[6px]">
      <span class="hand text-ink-soft text-[0.85rem]">length of task AI can complete</span>
      <div class="text-[0.7rem] text-ink-soft">(50% success rate)</div>
    </Reveal>
    ...
    <Reveal :delay="1500" class="!absolute left-[77px] top-[249px] w-[72px] text-center">
      ...
      <div class="text-[0.7rem] text-ink-soft">3 sec</div>
    </Reveal>
    <Reveal :delay="1770" class="!absolute left-[190px] top-[249px] w-[72px] text-center">
      ...
      <div class="text-[0.7rem] text-ink-soft">9 sec</div>
    </Reveal>
    <Reveal :delay="2190" class="!absolute left-[356px] top-[249px] w-[72px] text-center">
      ...
      <div class="text-[0.7rem] text-ink-soft">36 sec</div>
    </Reveal>
    <Reveal :delay="2420" class="!absolute left-[447px] top-[249px] w-[72px] text-center">
      ...
      <div class="text-[0.7rem] text-ink-soft">4 min</div>
    </Reveal>
    <Reveal :delay="2690" class="!absolute left-[553px] top-[249px] w-[72px] text-center">
      ...
      <div class="text-[0.7rem] text-ink-soft">7 min</div>
    </Reveal>
    <Reveal :delay="2900" class="!absolute left-[525px] top-[230px] w-[130px] text-right">
      <span class="font-semibold text-[0.85rem] text-ink">o3</span> <span class="text-[0.75rem] text-ink-soft">2 hrs</span>
    </Reveal>
    <Reveal :delay="2970" class="!absolute left-[555px] top-[205px] w-[130px] text-right">
      <span class="font-semibold text-[0.85rem] text-ink">GPT-5</span> <span class="text-[0.75rem] text-ink-soft">3.4 hrs</span>
    </Reveal>
    <Reveal :delay="3050" class="!absolute left-[585px] top-[183px] w-[130px] text-right">
      <span class="font-semibold text-[0.85rem] text-ink">GPT-5.2</span> <span class="text-[0.75rem] text-ink-soft">5.9 hrs</span>
    </Reveal>
    <Reveal :delay="3200" class="!absolute left-[150px] top-[112px]">
      <span class="hand text-ink-soft text-[1rem] bg-paper rounded px-2">duration roughly doubles every 6 months</span>
    </Reveal>
    <Reveal :delay="4250" class="!absolute left-[602px] top-[38px] w-[150px] text-right rounded bg-paper">
      ...
      <div class="text-[0.7rem] text-accent">±16 hrs (projected)</div>
    </Reveal>
  </div>
</div>

<!--
Beat for this slide: AI's ability to complete long tasks is growing exponentially, backed by measured data from METR.

- The metric: length of task (measured by how long it takes a human expert to complete it) that AI can finish with a 50% success rate. The Y axis is linear, so the explosion is visible: the curve hugs zero for years, then shoots up.
- The METR numbers (METR-Horizon v1.1 benchmark, metr.org/time-horizons): GPT-2 (Feb 2019) 3 sec, GPT-3 (May 2020) 9 sec, GPT-3.5 (Mar 2022) 36 sec, GPT-4 (Mar 2023) 4 min, GPT-4o (May 2024) 7 min, o3 (Apr 2025) 2 hrs, GPT-5 (Aug 2025) 3.4 hrs, GPT-5.2 (Dec 2025) 5.9 hrs.
- Left off the chart to keep it clean: o1 (Dec 2024) 39 min (the curve still passes through it) and GPT-5.4 (Mar 2026) 5.7 hrs, slightly below GPT-5.2.
- The GPT-5.6 Sol point (Jul 2026) is a projection, not a measurement: METR hasn't measured it yet. Based on METR's doubling trend (roughly every 6 months across the data, about 4 months since 2023), the estimate is 13 to 18 hrs; we plot 16 hrs, roughly two human workdays.
- Tie this to the workshop: tasks that take a human a day or two can now start being handed to an AI agent. That's why vibe coding only makes sense now.
- The slide animates automatically: axes, guide lines, data curve, model points in sequence, then the terracotta projection segment rises to the GPT-5.6 Sol point.
-->
...
<div class="h-full flex flex-col pt-6">
  <Reveal :delay="100">
    <h1 class="!text-[3rem] max-w-lg">You don't need to know how to code to get started</h1>
  </Reveal>
  ...
  <div class="relative mx-auto mt-14 h-[300px] w-[840px]">
    ...
    <Reveal :delay="1300" class="!absolute left-[-10px] top-[128px] w-[240px] text-center">
      ...
      <div class="mt-1 text-[0.95rem] leading-snug text-ink-soft">Describe what we want, let AI agents handle the rest.</div>
    </Reveal>
    <Reveal :delay="1700" class="!absolute left-[610px] top-[128px] w-[240px] text-center">
      ...
      <div class="mt-1 text-[0.95rem] leading-snug text-ink-soft">AI agents as working partners in software engineering.</div>
    </Reveal>
    <div v-click="1" class="absolute left-[255px] top-0 z-[1]">
      <span class="hand text-accent text-[1rem]">this session is here</span>
    </div>
    ...
    <div v-click="2" class="absolute right-[255px] top-0 z-[1] text-right">
      <span class="hand text-green-deep text-[1rem]">Vibe Coding Course</span>
    </div>
...
<!--
Beat for this slide: one axis to map the terms, then show where this workshop sits.

- Axis direction: further left means less coding knowledge needed, further right means more expert knowledge needed.
- Left end: vibe coding. We describe the outcome we want, and AI handles the rest, no need to know how to code first.
- Right end: agentic engineering. Working alongside AI agents as partners, often more than one at a time, while still reading and checking their output.
- [click] Where this workshop sits: near the vibe coding end, just a few inches to the right. We're not yet in software engineering territory.
- [click] Where the Vibe Coding Course sits: much closer to agentic engineering. In the course, participants learn to direct AI agents up to engineering-level work.
- The spectrum builds automatically as the slide appears; the "we are here" marker appears on the first click, the course marker on the second.
-->
...
<div class="h-full flex flex-col pt-6">
  <Reveal :delay="100">
    <h1>What is an <span class="relative inline-block">AI Agent<Rough class="!absolute -left-1 -bottom-4 pointer-events-none" shape="line" :width="210" :height="20" color="#c25c3b" :stroke-width="3.5" :delay="700" /></span>?</h1>
  </Reveal>
  ...
  <div class="mt-4 max-w-[46rem] flex flex-col gap-4">
    <Reveal :delay="900">
      <div class="flex items-start gap-3 text-2xl leading-[1.45] text-ink">
        <span aria-hidden="true" class="mt-3 size-2 shrink-0 rounded-full bg-ink"></span>
        <span>An AI system that acts autonomously and can use tools to complete a task.</span>
      </div>
    </Reveal>
  ...
  <Reveal :delay="900">
      <div class="flex items-start gap-3 text-2xl leading-[1.45] text-ink">
        <span aria-hidden="true" class="mt-3 size-2 shrink-0 rounded-full bg-ink"></span>
        <span>It can learn and adapt to our work and needs.</span>
      </div>
    </Reveal>
    <Reveal :delay="1500">
      <div class="flex items-start gap-3 text-2xl leading-[1.45] text-ink">
        <span aria-hidden="true" class="mt-3 size-2 shrink-0 rounded-full bg-ink"></span>
        <span>Examples: <b>Claude</b>, <b>Codex</b></span>
      </div>
    </Reveal>
  </div>
  ...
  <div class="relative mt-12 ml-5 h-[110px] w-[840px]">
    <Reveal :delay="2100" class="!absolute left-0 top-0">
      <Rough shape="rect" :width="130" :height="56" color="#3a332a" :stroke-width="2" :delay="2150" :seed="2">
        <span class="font-serif font-semibold text-lg text-ink">Try</span>
      </Rough>
    </Reveal>
    ...
    <Reveal :delay="2450" class="!absolute left-[196px] top-0">
      <Rough shape="rect" :width="170" :height="56" color="#3a332a" :stroke-width="2" :delay="2500" :seed="6">
        <span class="font-serif font-semibold text-lg text-ink">See result</span>
      </Rough>
    </Reveal>
    ...
    <Reveal :delay="2800" class="!absolute left-[432px] top-0">
      <Rough shape="rect" :width="160" :height="56" color="#3a332a" :stroke-width="2" :delay="2850" :seed="9">
        <span class="font-serif font-semibold text-lg text-ink">Adjust</span>
      </Rough>
    </Reveal>
    ...
    <Reveal :delay="3350" class="!absolute left-[250px] top-[66px] z-[1]">
      <span class="hand text-ink-soft bg-paper rounded px-2">try again</span>
    </Reveal>
  </div>
</div>

<!--
Beat for this slide: define AI agent through an easy-to-picture comparison, two example products, then how it works.

- Definition: an AI agent is like a reliable assistant we hand a task to, not a vending machine where you put in a question and get an answer out. A chatbot answers then stops; an agent keeps working until the task is done.
- Example products: Claude Code from Anthropic and Codex from OpenAI.
- How it works: it tries something, checks the result, adjusts, then tries again until it succeeds. Just like how a human gets work done.
- Reinforce the cue card line: we direct, the agent executes.
- The slide animates automatically: title, definition, examples, then the work loop.
-->